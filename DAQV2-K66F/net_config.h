...
#define USERDEF_SERVER_HTTP             ENABLED
...
#define SNMP_CLIENT_STACK_SIZE 1024//400
//HTTP stack size user-defined
#define HTTP_SERVER_STACK_SIZE 1024//800
//SNMP Agent stack
#define SNMP_AGENT_STACK_SIZE 800
//FTP client user-defined
#define USERDEF_CLIENT_FTP              ENABLED
//SW TIMER user-defined
#define USERDEF_SW_TIMER                DISABLED
//ADC Task user-defined
#define USERDEF_ADC_TASK                DISABLED
//USER INTERFACE user-defined
#define USERDEF_USER_INTERFACE          DISABLED
//IO INTERFACE user-defined
#define USERDEF_IO_INTERFACE            DISABLED

#define USERDEF_RS485_AGISSON           ENABLED //DISABLED
#define USERDEF_RS485_DKD51_BDP         ENABLED
#define USERDEF_RS485_VERTIV_M830B      ENABLED
//#define USERDEF_DEBUG_USING DISABLED
#define USERDEF_MONITOR_LIB             ENABLED
#define USERDEF_MONITOR_GEN             ENABLED   
#define USERDEF_MONITOR_BM              ENABLED
#define USERDEF_MONITOR_VAC             ENABLED
#define USERDEF_MONITOR_PM              ENABLED
#define USERDEF_MONITOR_SMCB            ENABLED //smcb
#define USERDEF_MONITOR_FUEL            ENABLED //fuel
#define USERDEF_MONITOR_ISENSE          ENABLED //isense
#define USERDEF_MONITOR_PM_DC           ENABLED // pm dc
#define USER_DEF_CHECK_GEN              ENABLED //check gen
#endif
